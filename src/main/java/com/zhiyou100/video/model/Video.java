...
public class Video {
	...
	public String getVideoLengthStr() {
		Integer hh = this.getVideoLength()/3600;  
		Integer mm = this.getVideoLength()%3600/60;
		Integer ss = this.getVideoLength()%60;
	...
	public String toString() {
		return "Video [id=" + id + ", videoTitle=" + videoTitle + ", speakerId=" + speakerId + ", courseId=" + courseId
				...
				+ ", videoPlayTimes=" + videoPlayTimes + ", speaker=" + speaker +  " Average="
				+ Average + ", videoLengthStr=" + videoLengthStr + "]";
	}
