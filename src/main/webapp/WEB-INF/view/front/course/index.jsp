...
<body class="w100">
	...
	<div id="app">
		<!--banner图-->
		<div class="banner"
			style="background-image: url('/ssh_video/static/img/banner-${subject.id}.jpg')"></div>
	...
	<script type="text/javascript">
		function getVideo(id){
			...
			location.href='/ssh_video/front/course/video_show.action?videoId='+id+'&subjectId='+subjectId;
		}
	</script>
