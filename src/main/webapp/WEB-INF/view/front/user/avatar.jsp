                ...
                <div class="proflle_tab_body">
                    <div class="proflle_tab_workplace clearfix">
                        ...
                        <div class="profile_ifo_area">
                            <form id="upload_form" enctype="multipart/form-data" method="post" action="${pageContext.request.contextPath}/front/personal/personal_avatar02.action" >
                                <p>请选择图像文件</p>
                                <div>
                                <input type="hidden" name="id"  value="${user.id }">
                                <input type="file" class="form-control" name="upload" id="image_file" accept="image/png,image/jpeg,image/jpg"/>
