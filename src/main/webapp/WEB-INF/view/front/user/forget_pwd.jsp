...
<body>
    ...
    <main>
        <div class="container">
            <form class="ma" action="${pageContext.request.contextPath}/front/forget/forget_pwd02.action" method="post" >
...
<%@include file="../include/script.html"%>
    <script type="text/javascript">
		function submitEmail(){
			...
			//改为ajax提交邮箱
			if(email!=null&&email!=''){
				$.post('/ssh_video/front/send/send_email.action',{email:email},function(data){
