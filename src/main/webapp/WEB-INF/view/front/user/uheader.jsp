	...
	<menu>
		<div class="container clearfix">
			<ul class="clearfix f_left">
				<li><a href="${pageContext.request.contextPath }/front/personal/personal_home.action">首页</a></li>
				<li class="menu_active"><a href="${pageContext.request.contextPath }/front/personal/personal_index.action">个人中心</a></li>
			</ul>
			<div id="user_bar">
				...
				<a href="${pageContext.request.contextPath }/front/personal/personal_logout.action" id="lay_out">退出</a>
			</div>
		</div>
	</menu>
</header>
