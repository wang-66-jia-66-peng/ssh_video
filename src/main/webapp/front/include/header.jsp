	...
	<div class="container">
		...
		<c:if test="${not empty _front_user}">
			<div id="userBlock" style="float:right">
				<a href="${pageContext.request.contextPath }/front/personal/personal_logout.action">退出</a>
				<a href="${pageContext.request.contextPath }/front/personal/personal_index.action" id="account">${sessionScope._front_user.email }</a>
			</div>
		</c:if>
